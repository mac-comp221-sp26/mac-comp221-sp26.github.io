...
1. **More than one way to tell the truth**
...
For example, if $c = [1, 3, 4, 4]$ and $n = 4$, you should split the rope into 2 pieces of length 2 and make $6. If one didn't split it, it's worth $4, and if one split it into pieces of lengths (1 and 3) or (2 and 1 and 1) it's worth $5. Similarly, if $c = [2, 3, 5, 7]$, one should split the rope into 4 pieces of size 1 and make $8. 
        > <details>
        >    <summary> Reveal/hide hint</summary>
