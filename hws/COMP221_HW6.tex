...
When showing the correctness of an algorithm (including for reductions), a brief sketch of the proof will suffice. Your proposed algorithms must still be correct to receive credit, and sketches should be clear and precise enough to allow for a peer to reconstruct a more detailed argument without any new insights into the problem. 
