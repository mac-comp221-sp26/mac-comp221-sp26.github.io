...
When showing the correctness of an algorithm (including for reductions), a brief sketch of the proof will suffice. Your proposed algorithms must still be correct to receive credit, and sketches should be clear and precise enough to allow for a peer to reconstruct a more detailed argument without needing any new insights into the problem. 
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \textbf{**Hint**}: Think through what graph methods we've seen that create spanning trees. Can one force a high degree vertex (and it's edges!) into a spanning tree?
